...
async function seedDatabase() {
  try {
    ...
    const tour7Days = await Tour.create({
      ...
      shortDescription: 'The essential northern circuit. Marvel at Hanoi’s historic street guilds, drift through Trang An’s limestone river caves, and sleep beneath the stars aboard a luxury Ha Long Bay vessel.',
    ...
    const tour10Days = await Tour.create({
      ...
      shortDescription: 'Our flagship journey linking Vietnam’s crown jewels. From Hanoi’s ancient streets and Ha Long’s waters to royal Hue palaces, lantern-lit Hoi An, and cosmopolitan Saigon.',
